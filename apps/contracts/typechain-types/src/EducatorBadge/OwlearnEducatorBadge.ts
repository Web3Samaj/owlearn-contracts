...
export interface OwlearnEducatorBadgeInterface extends utils.Interface {
  functions: {
    ...
    "updateOwlearnId(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "updateOwlearnId",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
...
export interface OwlearnEducatorBadge extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OwlearnEducatorBadgeInterface;
  ...
  functions: {
    ...
    updateOwlearnId(
      owlearnIdNew: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
